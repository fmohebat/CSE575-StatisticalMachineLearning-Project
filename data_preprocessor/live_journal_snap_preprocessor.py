...
def main():
    graph_file = '../raw_data/live-journal-snap/com-lj.ungraph.txt'
    community_file = '../raw_data/live-journal-snap/com-lj.all.cmty.txt'
    top5000_community_file = '../raw_data/live-journal-snap/com-lj.top5000.cmty.txt'
    ...
    snap_preprocessor.save_graph_to_edge_list(graph, node_info, fname='live-journal-snap')
